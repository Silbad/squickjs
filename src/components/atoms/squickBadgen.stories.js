...
export const base = {
    render: (argTypes) => ({
        ...
        template: '<SquickBadgen v-bind="args"><template v-slot:label-left>sqUIck</template><template v-slot:label-right>1.0.3</template></SquickButton>',
    }),
    argTypes: {
        TwdColor: {
            control: 'text',
